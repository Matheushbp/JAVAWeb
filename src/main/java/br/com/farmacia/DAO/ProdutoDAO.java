...
public class ProdutoDAO {
	public void salvar(Produtos p) throws SQLException {
		...
		sql.append("(descricao, preco, quatidade, fornecedores_codigo) ");
		sql.append("VALUES (?, ?, ?, ?) ");
	...
	public void excluir(Produtos f) throws SQLException {
		StringBuilder sql = new StringBuilder();
	...
	public void editar(Produtos f) throws SQLException {
		StringBuilder sql = new StringBuilder();
		...
		comando.setDouble(2, f.getPreco());
		comando.setDouble(4, f.getFornecedores().getCodigo());
		comando.setDouble(3, f.getQuantidade());
